...
Vue.prototype.$sMin = 0;
Vue.prototype.$sMax = 600;
Vue.prototype.$mMin = 601;
...
Vue.prototype.$editorOptions = {
  // Disable the default mobile theme and set it to "silver", which is the default desktop theme.
